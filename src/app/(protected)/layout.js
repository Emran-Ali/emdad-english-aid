...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <body className="leading-normal tracking-normal bg-cover bg-fixed min-h-screen" style={{ backgroundImage: 'url(/assets/image/header.png)' }}>
      {/*<body className="leading-normal tracking-normal text-indigo-400 s bg-cover bg-fixed min-h-screen" >*/}
      <ApiProvider>
      <div className="flex w-full absolute">
          <Menu/>
          <div className="relative w-full">
              <div className="sticky top-0 flex items-center justify-between px-4">
                  <div>
                      <span
