    ...
    <section class='relative py-4 overflow-hidden'>
      <div class='container px-4 mx-auto'>
        <div class='mb-20 md:max-w-xl text-center mx-auto'>
          <h2 class='font-heading text-3xl sm:text-5xl lg:text-7xl text-cyan-500 tracking-tighter-xl'>
            Features
          </h2>
        </div>
        <div class='relative mb-10 py-20 px-4 sm:px-16 bg-gradient-radial-dark overflow-hidden border border-gray-900 border-opacity-30 rounded-3xl'>
          <div class='max-w-7xl  mx-auto'>
            <div class='relative z-10 flex flex-wrap items-center -m-8'>
              <div class='w-full md:w-1/2 p-8'>
                <div class='max-w-md mx-auto text-center'>
                  <h2 class='mb-6 text-3xl sm:text-6xl text-white tracking-tighter-xl'>
                    Our features
                  </h2>
                  <ul>
                    <li className='items-center font-semibold text-lg sm:text-xl flex mb-6'>
                      <SlPaperPlane className='text-lime-400' />
                      <p class='px-2 md:px-4 text-white text-opacity-60'>
        ...
        <div class='flex flex-wrap -m-5'>
          <div class='w-full md:w-1/2 p-5'>
            <div class='relative px-4 sm:px-16 pt-14 pb-16 h-full bg-gradient-radial-dark overflow-hidden border border-gray-900 border-opacity-30 rounded-3xl'>
              ...
              <div class='relative z-10 max-w-sm text-center mx-auto'>
                <h2 class='mb-6 text-5xl text-white tracking-tighter'>
